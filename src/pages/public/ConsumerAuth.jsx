...
const ConsumerAuth = () => {
  ...
  const { loginConsumer, signupConsumer, loginWithGoogle, mockLogin } = useAuth();
  ...
  const subtitles = {
    ...
    register: 'Join LocalServe and book top-rated local professionals.',
    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-card">
          ...
          {/* Google sign-in — not shown on forgot */}
          {mode !== 'forgot' && (
            <>
